...
$select = $pdo->prepare("select subtotal as NenTotali,totali as GrandTotal,zbritjaPerqindje as ZbritjaP,zbritja as ZbritjaM,mPageses as Pagesa,kesh as Kesh,kusuri as Kusur from tbl_invoice where invoice_id = $p_id");
$select->execute();

$row = $select->fetch(PDO::FETCH_ASSOC);

$db_nentotali =  $row['NenTotali'];
$totali = $row['GrandTotal'];
$zbritjaP = $row['ZbritjaP'];
$zbritjaM = $row['ZbritjaM'];
$LlPageses = $row['Pagesa'];
$kesh = $row['Kesh'];
$kusuri = $row['Kusur'];
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="nentotali" id="nentotali" value="<?php echo $db_nentotali; ?>" readonly>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="zbritja_p" name="zbritja_p" value="<?php echo $zbritjaP; ?>">
                                            <div class="input-group-append">
                                                <span class="input-group-text">%</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="zbritja_m" id="zbritja_m" value="<?php echo $zbritjaM; ?>" readonly>
                                            <div class="input-group-append">
                                                <span class="input-group-text">&#8364;</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg total" name="grandTotal" id="grandTotal" readonly value="<?php echo $totali; ?>">
                                            <div class="input-group-append">
                                                <span class="input-group-text">&#8364;</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="txtpaid" id="txtpaid" value="<?php echo $kesh; ?>">
                                            <div class="input-group-append">
                                                <span class="input-group-text">&#8364;</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="txt_kusuri" id="txt_kusuri" value="<?php echo $kusuri; ?>" readonly>
                                            <div class="input-group-append">
                                                <span class="input-group-text">&#8364;</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-info" name="btnUpdate">Ndrysho Fakturen</button>
                                        </div>
            ...
            $.each(data, function(key, data) {
                if (jQuery.inArray(data["id"], productarr) !== -1) {
                    ...
                    function addrow(product_id, product_name, saleprice, stock, qty, barcode) {
                        // var tr ='<br>'+ product_id+'<br>'+product_name+' - Sasia ne depo '+stock+'(Cmimi ' +saleprice+')Sasia ne Fakture'+qty;
                        var result = qty * saleprice;
                        var tr = '<tr>' +
                            ...
                            '<td style = "text-align:left;vertical-align:middle; font-size:17px;"><span class="badge badge-danger totalamt" name="netamt_arr[]" id="saleprice_id' + product_id + '">' + result.toFixed(2) + '</span><input type="hidden" class="form-control saleprice" name="saleprice_arr[]" id="saleprice_idd' + product_id + '" value="' + saleprice + '"></td>' +
                            //Remove button//
