                ...
                <div class="col-lg-12">
                    <div class="card card-info card-outline">
                        <div class="card-header">
                            <h5 class="m-0">Pershkrimi i Produktit</h5>
                        </div>
                        <div class="card-body">
                            <?php
                            $id = $_GET['id'];
                            ...
                            while ($row = $select->fetch(PDO::FETCH_OBJ)) {
                                ...
                                <div class="col-md-6">
                                    <ul class="list-group">
                                        <center>
                                            <p class="list-group-item list-group-item-info"><b>Pershkrimi i Produktit</b></p>
                                        </center>
                                        <li class="list-group-item"><b>Barkodi</b> <span class="badge badge-light float-right">'.bar128($row->barcode). '</span></li>
